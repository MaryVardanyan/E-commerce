                    ...
                    <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6 fl_end_addCotegory">
                                    <a href="{{route('user.orders')}}" class="btn btn-success pull-right m_r_10">Мои заказы</a>
                                    @if($order->status == 'ordered')
                                        <a href="#" wire:click.prevent="cancelOrder" class="btn btn-warning pull-right">Отменить заказ</a>
                                    @endif
                                </div>
                            </div>
                    </div>
                        ...
                        <div class="wrap-iten-in-cart m_b_30">
                            ...
                            <ul class="products-cart">
                                ...
                                <li class="pr-cart-item">
                                    ...
                                    <div class="price-field produtc-price"><p class="price">{{$item->price}} р.</p></div>
                                    <div class="quantity">
                                       <h5>{{$item->quantity}}</h5>
                                    </div>
                                    <div class="price-field sub-total"><p class="price">{{$item->price * $item->quantity}} р.</p></div>
                                    @if($order->status == 'delivered' && $item->rstatus == false)
                                        <div class="price-field sub-total"><p class="price"><a href="{{route('user.review', ['order_item_id' => $item->id])}}">Оставить отзыв</a></p></div>
                                    @endif
                                </li>
                                @endforeach						
                            </ul>
                    ...
                    <div class="panel-body">
                        <div class="summary">
                                <div class="order-summary">
                                    ...
                                    <!-- <p class="summary-info"><span class="title">Налог</span><b class="index">{{$order->tax}} руб.</b></p> -->
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <table>
                        ...
                        @elseif($order->transaction->status == 'delivered')
                        <tr>
                            <th class="pad_r_10">Статус: </th>
                            <td>доставлен</td>
                        </tr>
