                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{route('admin.coupons')}}" class="btn btn-success pull-right">Все купоны</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal flex_column_category" wire:submit.prevent="storeCoupon">
