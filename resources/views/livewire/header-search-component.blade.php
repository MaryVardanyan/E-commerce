								...
								<form action="{{route('product.search')}}" id="form-search-top" name="form-search-top">
									<input type="text" name="search" value="{{$search}}" placeholder="Поиск..." style="font-size: 16px; width: 350px;">
									...
									<div class="wrap-list-cate">
										...
										<a href="#" class="link-control f-z13">Все категории</a>
										<ul class="list-cate">
											<li class="level-0">Все категории</li>
